...
import com.wallpaintapp.R
import kotlinx.android.synthetic.main.activity_paint_wall_main.*
...
class PaintWallMainActivity : AppCompatActivity() {
...
//        Scalar(200.0, 0.0, 0.0)
    ...
    private val TAG = PaintWallMainActivity::class.java.simpleName
...
//    private val PICK_FROM_GALLERY = 2
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_paint_wall_main)
...
//                    startActivityForResult(i, PICK_FROM_GALLERY)
    ...
    private fun openCamera() {
        if (ActivityCompat.checkSelfPermission(baseContext, Manifest.permission.CAMERA)
            ...
            if (photoFile != null) {
                val photoURI = FileProvider.getUriForFile(this,"com.wallpaintapp.provider", photoFile)
...
//        bottomLayout.visibility = View.GONE
        ...
        try {
            ...
            Toast.makeText(this@PaintWallMainActivity, "No image selected",Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun chooseColor() {
        ...
        val colorPicker = AmbilWarnaDialog(this@PaintWallMainActivity, chosenColor, object: AmbilWarnaDialog.OnAmbilWarnaListener {
